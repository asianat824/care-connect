...
export function seedState(): AppState {
  return {
        ...
        responses: [
          {
            ...
            role: "Brother",
            status: "Accepted",
            note: "Accepted today at 3:18 PM",
          },
          {
            memberId: "m2",
            name: "Denise Park",
    ...
    tasks: [
      ...
      {
        id: "t4",
        title: "Pick up Mama Ruth's groceries",
        kind: "Caregiving",
        personId: "p1",
        bucket: "This is outside my capacity",
        status: "Delegated",
        done: false,
        createdAt: today(),
      },
      {
        id: "t5",
        title: "Check whether her medication changed",
        kind: "Caregiving",
        personId: "p1",
      ...
      {
        id: "t6",
        title: "Ask Marcus about next week's rides",
        kind: "Caregiving",
        personId: "p1",
        bucket: "I may need help",
        status: "To do",
        done: false,
        createdAt: today(),
      },
      {
        id: "t7",
        title: "Water the garden beds with her",
        kind: "Caregiving",
        personId: "p1",
        bucket: "I can handle this",
        status: "In progress",
      ...
      {
        id: "t2",
        title: "Schedule my own doctor's appointment",
        kind: "Personal",
        bucket: "Not sorted yet",
        status: "To do",
        done: false,
